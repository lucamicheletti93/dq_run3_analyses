...
void accxeff() {
    ...
    string productionName = "LHC24g8"; // prompt charmonia at forward in Pb-Pb https://its.cern.ch/jira/browse/O2-5286
    //string productionName = "LHC24e4"; // non-prompt charmonia at forward in pp https://its.cern.ch/jira/browse/O2-4885
    //string productionName = "LHC24e5"; // prompt charmonia at forward in pp https://its.cern.ch/jira/browse/O2-4884
