...
void projections() {
    ...
    string pathName = "/Users/lucamicheletti/cernbox/JPSI/Jpsi_pp_cross_section_run3"; // <----- Default tag and probe
    ...
    const int nPtBins1 = 7;
    double minPtBins1[] = {0, 1, 2, 3, 4, 5, 7};
    double maxPtBins1[] = {1, 2, 3, 4, 5, 7, 20};
    const int nRapBins1 = 1;
    double minRapBins1[] = {2.5};
    double maxRapBins1[] = {4};
