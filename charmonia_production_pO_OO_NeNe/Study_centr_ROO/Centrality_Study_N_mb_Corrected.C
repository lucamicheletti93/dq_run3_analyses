...
// va bene sia per normalization_Corrected.C (anche normalization_Corrected_ALL.C e normalization_Corrected_ALLTVXCounter.C) sia per normalization_Corrected_DQ_stream.C 
...
void check_centrality(string fileName1 = "LHC25ae_pass2_minBias_std_assoc_trigger_summary_NTVX_Plus_CorrEvSelFirstCorrected_Plus_PileUp_in_Integrated_Plus_PileUp_and_Not_in_Centr__Train_706903_Centr_0_100_Sel8NoSameBunch.root", string fileName2 = "luminosity_jpsi_LHC25_LHC25ae_pass2_minBias_NTVX_Plus_CorrEvSelCorrected_Plus_PileUp_in_Integrated_Plus_PileUp_and_Not_in_Centr__Train_706903_Centr_0_100_Sel8NoSameBunch.root") {
    ...
    // ---------------
    TH1D *hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker = (TH1D*) f2->Get("hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker");
    TH1D *hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100 = new TH1D("hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100", hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker->GetTitle(), 10, 0.5, 10.5);

    // Copy the first 10 bin (0-10, 10-20, ... , 90-100)
    for(int i=1; i<=10; i++){
        hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100->SetBinContent(i, hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker->GetBinContent(i));
        hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100->SetBinError(i, hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker->GetBinError(i));
        hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100->GetXaxis()->SetBinLabel(i, hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker->GetXaxis()->GetBinLabel(i));
    }

    hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100->SetDirectory(0);
    ...
    hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100->SetMarkerStyle(20);
    hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100->SetMarkerSize(1.2);
    hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100->SetLineColor(kBlack);
    hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100->SetStats(0);
    hist_CentrFT0C_N_AfterCuts_TReader_Divided_N_BeforeCuts_TMaker_Until100->Draw("HIST");
