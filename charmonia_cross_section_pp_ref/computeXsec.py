...
def xsec(config):
    ...
    histStatRawYieldInt.GetYaxis().SetRangeUser(1e2, 5e5)
    histStatRawYieldInt.Draw("EP")
    #histSystRawYieldInt.Draw("E2P SAME")
    ...
    legendXsecIntVsRun2.AddEntry(graStatXsecInt, "#sqrt{#it{s}} = 5.36 TeV", "FP")
    ...
    # Compare to Run 2 results
    filePathJpsi = "/Users/lucamicheletti/GITHUB/dq_run3_analyses/psi2S_jpsi_ratio/results/HEPData-77781-v1-yaml/Table7.yaml"
    ...
    legendXsecVsPtVsRun2.AddEntry(graSystXsecVsPtRun2, "#sqrt{#it{s}} = 5.02 TeV, EPJC 77 (2017) 392", "FP")
    legendXsecVsPtVsRun2.AddEntry(graStatXsecVsPt, "#sqrt{#it{s}} = 5.36 TeV", "FP")
    ...
    histSystRelMcRealisticInt .Write("syst_mc_realisticness_int")
